...
(function() {
	...
	var MODULE = angular.module('com.duongna.eval',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/com.duongna.eval/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/com.duongna.eval/main/htm/about.htm'});
